...
<div class="widget hidden-xs m30">
    ...
    <img class="img-responsive adv_img" src="{{asset('puublic/front/img/right_add4.jpg')}}" alt="add_one">
</div>
<!-- Advertisement -->
...
<!-- jquery Core-->
<script src="public/front/js/jquery-2.1.4.min.js"></script>

<!-- Bootstrap -->
<script src="{{asset('public/front/js/bootstrap.min.js')}}"></script>

<!-- Theme Menu -->
<script src="{{asset('publiv/front/js/mobile-menu.js')}}"></script>
